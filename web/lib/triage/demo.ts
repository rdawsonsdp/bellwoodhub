...
export const DEMO_TRIAGE: TriageView = {
  needsReply: [
    {
      messageId: "demo-1", sourceRef: "demo-1", subject: "Re: FOIA request 2026-114 — records still outstanding",
    ...
    {
      messageId: "demo-2", sourceRef: "demo-2", subject: "Water main on Bohland — resident asking for an update",
    ...
    {
      messageId: "demo-3", sourceRef: "demo-3", subject: "Following up — vendor invoice approval",
  ...
  awaitingOthers: [
    {
      messageId: "demo-4", sourceRef: "demo-4", subject: "Re: Budget figures for the Q3 board packet",
  ...
  fyi: [
    {
      messageId: "demo-5", sourceRef: "demo-5", subject: "Your weekly Village digest",
